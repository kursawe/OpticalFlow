...
def visualise_PIV_result():
    PIV_result = scipy.io.loadmat(os.path.join(os.path.dirname(__file__), 'data', 'PIVlab_actin.mat'))
    ...
    threshold_masks = actin_movie_blurred < 30
    ...
    saving_name = os.path.join(os.path.dirname(__file__),'output', 'piv_visualisation.mp4')
    ...
    plt.savefig(os.path.join(os.path.dirname(__file__),'output', 'piv_speed_histogram.pdf'))

if __name__ == '__main__':
    visualise_PIV_result()